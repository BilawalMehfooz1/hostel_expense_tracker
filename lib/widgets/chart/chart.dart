...
import 'package:hostel_expense_tracker/widgets/chart/chart_bar.dart';
...
class Chart extends StatelessWidget {
  ...
  List<ExpenseBucket> get buckets {
    return [
      ...
      ExpenseBucket.forCategory(expenses, Category.fastfood),
      ExpenseBucket.forCategory(expenses, Category.travel),
      ExpenseBucket.forCategory(expenses, Category.gym),
      ExpenseBucket.forCategory(expenses, Category.mess),
      ExpenseBucket.forCategory(expenses, Category.rent),
      ExpenseBucket.forCategory(expenses, Category.shopping),
      ExpenseBucket.forCategory(expenses, Category.cigrattes),
      ExpenseBucket.forCategory(expenses, Category.prints),
